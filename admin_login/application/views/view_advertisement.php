                                    ...
                                    if (!empty($fetch_advertisement)) {
                                        ...
                                        foreach ($fetch_advertisement as $category) { ?>
                                            <tr>
                                                ...
                                                <th><?php echo $category->product_name; ?></th>
                                                <td><?php echo $category->product_quantity; ?></td>
                                                ...
                                                <td><?php echo $category->product_actual_price; ?></td>
                                                <td><?php echo $category->product_offer_price; ?></td>
                                                <td><?php echo limit_text($category->product_description, 10); ?></td>
                                                <td><?php echo limit_text($category->product_description_main, 10); ?></td>
