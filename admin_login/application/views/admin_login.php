            ...
            <div class="auth-box">
                <div id="loginform">
                    <div class="logo">
                        ...
                        <h5 class="font-medium mb-3">Admin Login </h5>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form class="form-horizontal mt-3" action="<?= base_url() ?>index.php/login_check" method="POST" >
