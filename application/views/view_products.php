			...
			$.ajax({
				...
				.done(function(response) {
					...
					$.each(data, function(index, val) {
						...
						html += "<a href=" + "'<?= base_url() ?>index.php/add_to_cart_by_ajax?advertisement_id=" + val['advertisement_id'] + "'" + ">";
						html += "<button class='btn-icon btn-add-cart'  ><i class='icon-shopping-cart'></i></button>";
						html += " </a>";
