					...
					<div class="header-left">
						<div class="header dropdown-expanded mr-3">
							...
							<?php if ($this->session->userdata('user_email')) { ?>
								...
								<a href="<?php base_url() ?>user_logout">Logout</a>
							<?php } else { ?>
						...
						<?php if ($this->session->userdata('user_email')) { ?>
							<p class="top-message mb-0 mr-lg-5 pr-3 d-none d-sm-block">
								<a href="<?php base_url() ?>user_logout">
									Logout
								</a>
							</p>
						<?php } else { ?>
				...
				<div class="container">
					<div class="header-left col-lg-2 w-auto pl-0">
						...
						<a href="<?= base_url() ?>index.php/home" class="logo">
							<img src="<?= base_url() ?>assets/images/techstreet.jpeg" alt="Porto Logo">
						</a>
						</div>
					</div><!-- End .header-left -->
					...
					<div class="dropdown cart-dropdown">
						...
						<div class="dropdown-menu">
							<div class="dropdownmenu-wrapper">
								<div class="dropdown-cart-header">
									<span> <?php echo $i ?> Items</span>

									<a href="<?= base_url() ?>index.php/view_cart" class="float-right">View Cart</a>
								</div><!-- End .dropdown-cart-header -->
										...
										<div class="product">
											<div class="product-details">
												<h4 class="product-title">
													<a href="<?= base_url() ?>index.php/view_cart"><?= $cart['name'] ?></a>
												</h4>
											...
											<figure class="product-image-container">
												<a href="<?= base_url() ?>index.php/view_cart" class="product-image">

													<div>

														<img class="img-fluid" src="<?= base_url() ?>admin_login/uploads/<?= $cart['image'] ?>" alt="product" style="object-fit: fill;">
													</div>
								...
								<div class="dropdown-cart-total">
									...
									<span class="cart-total-price float-right">₹<?php echo $this->cart->total(); ?></span>
								</div><!-- End .dropdown-cart-total -->

								<div class="dropdown-cart-action">
									<a href="<?= base_url() ?>index.php/view_cart" class="btn btn-dark btn-block">Checkout</a>
								</div><!-- End .dropdown-cart-total -->
							</div><!-- End .dropdownmenu-wrapper -->
						</div><!-- End .dropdown-menu -->
					</div><!-- End .dropdown -->
			...
			<div class="info-boxes-container row row-joined mb-2 font2">
				<div class="info-box info-box-icon-left col-lg-4">
					...
					<div class="info-box-content">
						<h4>FREE SHIPPING &amp;</h4>
						<p class="text-body">Free shipping on all orders over ₹199</p>
			...
			<div class="row">
				<div class="col-lg-9">
							...
							<div class="product-default inner-quickview inner-icon">
								<figure>
									...
									<div class="btn-icon-group">
										<button class="btn-icon btn-add-cart addToCartButton" data-advertisement_id="<?= $get->advertisement_id ?>"><i class="icon-shopping-cart"></i></button>
									</div>
								...
								<div class="product-details">
									<div class="category-wrap">
										...
										<a href="#" class="btn-icon-wish addToCartButton" data-advertisement_id="<?= $get->advertisement_id ?>"><i class="icon-shopping-cart"></i></a>
									</div>
					...
					<div style="text-align: center;" >
						...
						<a href="<?= base_url() ?>index.php/view_products" class="" title="Add to Cart"><button type="submit" class="btn btn-primary">View All</button></a>
					</div>
					<br>
					...
					<div class="widget widget-banners px-5 pb-3 text-center">
						<div class="owl-carousel owl-theme">
							<div class="banner d-flex flex-column align-items-center">
								...
								<a href="<?= base_url() ?>index.php/view_products" class="btn btn-dark btn-md font1">View Sale</a>
							</div><!-- End .banner -->
	...
	<footer class="footer bg-dark">
				...
				<div class="row">
					<div class="col-lg-3 col-sm-6 pb-5 pb-sm-0">
						<div class="widget">
							...
							<div style="width: 105px;">
							<img src="<?= base_url() ?>assets/images/techstreet.jpeg" alt="Logo" class="m-b-3">
							</div>
					...
					<div class="col-lg-3 col-sm-6 pb-5 pb-sm-0">
						<div class="widget">
							...
							<ul class="links">
								<?php if ($this->session->userdata('user_email')) { ?>
									<li><a href="<?= base_url() ?>index.php/view_products">View All Products</a></li>
									<li><a href="<?= base_url() ?>index.php/user_orders">Orders History</a></li>
								...
								<?php	} else { ?>
									<li><a href="<?= base_url() ?>index.php/view_products">View All Products</a></li>
									<li><a href="<?= base_url() ?>index.php/user_signup">New User!!</a></li>
		...
		<div class="container">
			<div class="footer-bottom d-flex justify-content-between align-items-center flex-wrap">
				<p class="footer-copyright py-3 pr-4 mb-0">© Gupta Watch House. 2020. All Rights Reserved</p>
		...
		<div class="mobile-menu-wrapper">
			...
			<nav class="mobile-nav">
				...
				<ul class="mobile-menu">
					...
					<li><a href="<?= base_url() ?>index.php/contact_us">Contact Us</a></li>
					<?php if ($this->session->userdata('user_email')) { ?>
						<li class=""><a href="<?= base_url() ?>index.php/user_logout">Logout</a></li>
					<?php } ?>
				</ul>
			</nav><!-- End .mobile-nav -->
