			...
			<div class="row">
				...
				<div class="col-md-7 product-single-details">
					...
					<div class="product-action">
						...
						<a href="#" class="btn btn-dark add_cart add-cart icon-shopping-cart"  data-advertisement_id="<?php echo $view_advertisement['advertisement_id']; ?>" title="Add to Cart">Add to Cart</a>
