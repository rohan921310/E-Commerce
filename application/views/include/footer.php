						...
						<div class="col-lg-3 col-sm-6 pb-5 pb-sm-0">
							<div class="widget">
								...
								<ul class="contact-info m-b-4">
									...
									<li>
										<span class="contact-info-label">Email:</span> <a
											href="mailto:<?= $basic_info['company_email'] ?>"><?= $basic_info['company_email'] ?></a>
									</li>
									<li>
								...
								<div class="social-icons">
									<a href="<?= $basic_info['company_facebook_link'] ?>" class="social-icon social-facebook icon-facebook" target="_blank"
										title="Facebook"></a>
									<a href="<?= $basic_info['company_insta_link'] ?>" class="social-icon social-instagram icon-instagram" target="_blank"
										title="Twitter"></a>
									<a href="https://api.whatsapp.com/send/?phone=<?= $basic_info['company_mobile'] ?>&text&app_absent=0" class="social-icon social-whatsapp fab fa-whatsapp" target="_blank"
										title="Whatsapp"></a>
...
<!-- Mirrored from portotheme.com/html/porto_ecommerce/demo_6/category.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Nov 2020 08:37:51 GMT -->
