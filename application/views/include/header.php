					...
					<div class="header-left">
						<div class="header dropdown-expanded mr-3">
							...
							<?php if ($this->session->userdata('user_email')) { ?>
								...
								<a href="<?php base_url() ?>index.php/user_logout">Logout</a>
							<?php } else { ?>
						...
						<?php if ($this->session->userdata('user_email')) { ?>
							<p class="top-message mb-0 mr-lg-5 pr-3 d-none d-sm-block">
								<a href="<?php base_url() ?>index.php/user_logout">
									Logout
								</a>
							</p>
						<?php } else { ?>
				...
				<div class="container">
					<nav class="main-nav w-100">
						<ul class="menu">
							...
							<?php if ($this->session->userdata('user_email')) { ?>
								<li class="float-right"><a href="<?= base_url() ?>index.php/user_logout">Logout</a></li>
							<?php } ?>
