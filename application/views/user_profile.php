			...
			<div class="container mt-2 ">
				<div class="row">
					<div class="col-lg-9 order-lg-last dashboard-content">
						...
						<form action="<?= base_url() ?>index.php/change_user_detials" method="POST" id="" >
							<div class="row">
								<div class="col-sm-11">
									<div class="row">
										<div class="col-md-4">
							...
							<div class="form-footer">
								<a href="<?= base_url() ?>index.php/view_products"><i class="icon-angle-double-left"></i>Back To Shopping</a>
					...
					<aside class="sidebar col-lg-3">
						<div class="widget widget-dashboard">
							...
							<ul class="list">
								...
								<li><a href="<?= base_url() ?>index.php/user_orders">My Orders</a></li>
